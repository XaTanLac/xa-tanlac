...
import { IImagePosting, useArticleDetailMemo } from '@/hooks/use-article'
...
const ViewImagePage: React.FC = () => {
  ...
  const [image, loading] = useArticleDetailMemo<IImagePosting>(MY_POSTING_API.IMAGE_DETAILS(id || ''), {}, [])
