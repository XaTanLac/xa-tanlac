...
import { IAudioPosting, useArticleDetailMemo } from '@/hooks/use-article'
...
const ViewAudioPage: React.FC = () => {
  ...
  const [audio, loading] = useArticleDetailMemo<IAudioPosting>(MY_POSTING_API.AUDIO_DETAILS(id || ''), {}, [])
